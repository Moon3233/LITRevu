...
SEED_COVERS_DIR = Path(__file__).resolve().parents[2] / 'seed_assets' / 'covers'
...
BOOKS = [
    ...
    },
    {
        ...
        'description': (
            "Je l'offre à ma nièce de 9 ans. Par quelle édition illustrée vous avez-vous "
            "été marqué·e ? Faut-il laisser les chapitres sur la rose et le renard "
            "pour plus tard ?"
        ),
    ...
    },
    {
        ...
        'description': (
            "Après les films : vaut-il le coup de s'attaquer aux trois volumes cette année ? "
            "Les passages de chants et de géographie vous ont-ils rebuté ou transporté ?"
        ),
    ...
    },
    {
        ...
        'description': (
            "Je (re)lis la saga avant de la conseiller à ma cousine de 15 ans. "
            "Le premier tome reste-t-il aussi prenant qu'à sa sortie, ou le comparatif "
    ...
    },
    {
        ...
        'description': (
            ...
            "Le polar tient-il la route dès ce premier tome, ou faut-il attendre "
...
REVIEWS_DATA = [
    {
        ...
        'body': (
            "La novlangue et la mise en abyme de la réécriture des faits résonnent "
            "avec les débats sur l'info aujourd'hui. Orwell ne prédit pas une tech "
            "précise : il décrit des mécanismes de pouvoir. Idéal pour un club qui "
    ...
    },
    {
        ...
        'body': (
            "Hugo, je rejoins l'idée du parallèle actuel, mais c'est la part intime "
            "qui m'a le plus touché : la fragilité du lien humain sous surveillance. "
            "La chambre au-dessus de la boutique antique reste l'une des scènes "
    ...
    },
    {
        ...
        'body': (
            "Sophie, pour 9 ans : oui aux chapitres rose et renard, ils sont concrets "
            "sans être moralisateurs. L'édition Folio classique ou Gallimard jeunesse "
            "tient bien. Lisez à voix haute : les répétitions deviennent des refrains."
        ),
    ...
    },
    {
        ...
        'body': (
            "Thomas, attaque les trois volumes si tu as le temps : la Communauté "
            "est la plus accessible, mais c'est au Two Towers que la guerre devient "
            "grise. Les chants ? Survole-les la première fois, reviens-y ensuite."
        ),
    ...
    },
    {
        ...
        'body': (
            "Demo : pour ton neveu, commence par lui dire que les 200 premières pages "
            "sont un investissement. Château d'If = tension pure. Ensuite la vengeance "
            "devient un jeu d'échecs. Même sans te suivre, je vois ce billet car "
    ...
    },
    {
        ...
        'body': (
            ...
            "est déjà calée sur le visuel des films — difficile de faire autrement. "
            "Mais le livre apporte tellement de personnages absents à l'écran, "
            "de scènes et de décors inédits que l'ensemble reste très vivant. "
            "Au final, l'imagination n'est impactée que légèrement : on retrouve "
    ...
    },
    {
        ...
        'body': (
            "Hugo, le premier tome accroche dès les premiers chapitres : le rythme, "
            "la tension, le côté « téléréalité » glaçant. Même en connaissant la fin "
    ...
    },
    {
        ...
        'body': (
            "Demo, le premier tome pose bien l'enquête et le duo Strike / Robin. "
            "C'est dense, très londonien, parfois un peu long sur la mise en place, "
            "mais la fin justifie la patience. Parfait si tu aimes le polar sans "
            "violence gratuite."
        ),
...
class Command(BaseCommand):
    help = 'Charge une base de démonstration avec livres connus et couvertures.'
    ...
    def handle(self, *args, **options):
        ...
        users = {
            name: User.objects.create_user(username=name, password=DEMO_PASSWORD)
            for name in USERS
        }
        ...
        for book in BOOKS:
            ...
            if cover_path:
                with cover_path.open('rb') as cover_file:
                    ticket.image.save(f"{book['key']}.jpg", File(cover_file), save=True)
                covers_ok += 1
        ...
        self.stdout.write(
            f'{Ticket.objects.count()} billets, {Review.objects.count()} critiques.'
        )
    ...
    def _ensure_cover(
        ...
        *,
        ...
        self.stdout.write(self.style.WARNING(f'Couverture introuvable pour {slug}'))
        return None
